...
HOST_IP = os.getenv("HOST_IP") if os.getenv("HOST_IP") else "127.0.0.1"
MINIO_PORT = os.getenv("MINIO_PORT") if os.getenv("MINIO_PORT") else "9000"
MINIO_ENDPOINT = f"{HOST_IP}:{MINIO_PORT}"
MINIO_ACCESS_KEY = os.getenv("MINIO_ACCESS_KEY") if os.getenv("MINIO_ACCESS_KEY") else "minioadmin"
MINIO_SECRET_KEY = os.getenv("MINIO_SECRET_KEY") if os.getenv("MINIO_SECRET_KEY") else "minioadmin"
